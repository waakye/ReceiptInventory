...
public class ReceiptProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // so we know what content URI the Cursor was created for.  If the data at this URI changes,
    ...
    private int updateReceipt(Uri uri, ContentValues values, String selection,
        ...
        int rowsUpdated = database.update(ReceiptContract.ReceiptEntry.TABLE_NAME, values,
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch(match) {
            case RECEIPTS:
                ...
                rowsDeleted = database.delete(ReceiptContract.ReceiptEntry.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case RECEIPT_ID:
